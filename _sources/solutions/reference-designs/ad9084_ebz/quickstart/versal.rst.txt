...
Build one of the supported devicetrees ``versal-vck190-reva-ad9084-*.dts``, such as
``versal-vck190-reva-ad9084-204C-M4-L4-NP16-20p0-4x4.dts``.

.. shell::
   :show-user:

   /github-linux-build/linux
   $ls arch/arm64/boot/dts/xilinx/versal-vck190-reva-ad9084-*.dts
     arch/arm64/boot/dts/xilinx/versal-vck190-reva-ad9084-204C-M4-L4-NP16-20p0-4x4.dts
   $make xilinx/versal-vck190-reva-ad9084-204C-M4-L4-NP16-20p0-4x4.dtb
     DTC     arch/arm64/boot/dts/xilinx/versal-vck190-reva-ad9084-204C-M4-L4-NP16-20p0-4x4.dtb
...
.. shell::
   ...
   $cp arch/arm64/boot/dts/xilinx/versal-vck190-reva-ad9084-204C-M4-L4-NP16-20p0-4x4.dtb /media/BOOT/system.dtb
...
#. To change VADJ_FMC On BEAM, click "Test The Board">"Board Settings">"FMC".
   ...
   .. tip::
      ...
      Alternatively to the GUI, you can setup VADJ and reboot with ``curl``:

      .. shell::

         # Update according the BEAM Tool Web Address
         $URL=128.0.0.84
         $until curl \
         $    'http://$URL:50002/cmdquery?sc_cmd=setvoltage&target=VADJ_FMC&params=1.5' \
         $    --connect-timeout 1 ; \
         $  do sleep 1 ; done
         $until curl \
         $    'http://$URL:50002/cmdquery?sc_cmd=reset&target=&params=' \
         $    --connect-timeout 1 ; \
         $  do sleep 1 ; done
