...
- Micro SD card with at least 16GB of memory with the ADI Kuiper image
- Micro SD card with the ACAP System controller image
- USB type-C cable (UART)
- LAN cable (Ethernet)
...
``versal-vck190-reva-ad9081`` folder from the SD card imaged with the
...
.. collapsible:: Complete boot log
   ...
   ::
      ...
      *** Warning - bad env area, using default environment
      ...
      [    1.914213] axi_sysid a5000000.axi-sysid-0: [ad9081] [8B10B RX:RATE=9.83 M=8 L=4 S=1 LINKS=1 TX:RATE=9.83 M=8 L=4 S=1 LINKS=1] on [vck190] git branch <main> git <c9e9fcdff39b1940
