...
`Source and LTspice simulation for this page <https://github.com/thorenscientific/documentation/blob/main/docs/scratchpad/ltspice_examples/lvds_pair/index.rst>`__

Pages are "atomic" and can be moved around, and by using tags, you can reference one page from another without worrying about breaking links. This page is tagged with "ltspice_example_lvds_pair" so you can reference it from anywhere else like this: :ref:`ltspice_example_lvds_pair`. Hover over the link to check the URL.
